...
Proportional improvement among educators, but a wide gap remains
...
plot_xy <- function(df) {
  ...
  theme(legend.position = "none", #hide legend since it is encoded in title
        ...
        axis.title.x = element_text(vjust = -1), #move x axis title downards
        strip.text = element_markdown(size=14), #increase size of header text
        plot.title = element_markdown(), #allow encoding of color
        plot.subtitle = element_markdown(), #allow encoding of color
        ) +
...
Many possible **programming languages** and **reporting tools**: <br> R and Quarto provide an efficient way to create presentations; facillitate collaboration; and promote transparency
